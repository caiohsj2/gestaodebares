...
<?php 
	if(isset($_GET['fecha'])){
		...
		$id_mesa = $_GET['id_mesa'];
			...
			$delete = mysqli_query($db,"UPDATE pedido SET situacao ='0', idGarcon = '' WHERE id_mesa = '$id_mesa' ")or die(mysql_error());
			$up = mysqli_query($db,"UPDATE entrega SET situacao = '0' WHERE id_mesa = '$id_mesa'")or die(mysql_error());
		}
	}
?>
