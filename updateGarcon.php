...
<div id="boxcadProdutos">
  ...
  <strong>Nível de acesso:</strong><br/>
    ...
    Cozinha:<input name="nv" type="radio" value="2" <?php if($nivel == 2){echo "checked='checked'";}?>/> |
    
    Diversos:<input name="nv" type="radio" value="3" <?php if($nivel == 3){echo "checked='checked'";}?> /><br/>
