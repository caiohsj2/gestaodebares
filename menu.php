<ul id="css3menu1" class="topmenu">
	...
	<li><a href="inicio.php?btn=config"><img src="imagens/pic_3.png" width="40" alt=""/>Configurações</a>
     ...
     <ul>
            ...
            <li><a href="inicio.php?btn=cadastroProdutos">Cadastro de Produtos</a></li>

            <li><a href="inicio.php?btn=alterapreco">Alterar Preços / Excluir</a></li>
