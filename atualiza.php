...
include "config/conexao.php"; 
 ...
 if($_GET['btn'] =="cancela"){
	...
	$del = mysqli_query($db,"DELETE FROM tbl_carrinho WHERE comanda = '$num' ") or die($db->error);
...
<table width="100%" border="0" class="inputs">
  ...
  $sql = mysqli_query($db,"SELECT * FROM tbl_carrinho WHERE comanda='$comand'") or die(mysql_error());
