...
<head>
      ...
      <title>Bar e Restaurante - Sistemas OFF</title>
...
<div id="categories" data-role="page" data-title="Categories">
      ...
      <div data-role="header">
            ...
            <h1>Olá, <?php echo $mostra['nomeGarcon'] ?></h1>
...
<ul>
	...
	<li><a href="inicio.php?id_mesa=<?php echo $id_mesa ?>&idGarcon=<?php echo $idGarcon ?>"><?php echo $img; echo "<br/>";  echo 'Nº '.$numero;  echo "<br/>"; if($situacao == 1){echo "".$nomeGarcon; }else{echo "Abrir";} ?></a></li>
